...
namespace FIEAGameEngine
{
	...
	{
	public:
		[[nodiscard]] const std::chrono::high_resolution_clock::time_point&
			CurrentTime() const;
		...
		void SetElapsedGameTime(const std::chrono::milliseconds&
			elapsedGameTime);
		[[nodiscard]] std::chrono::duration<float> TotalGameTimeSeconds()
			const;
		[[nodiscard]] std::chrono::duration<float> ElapsedGameTimeSeconds()
			const;
	private:
